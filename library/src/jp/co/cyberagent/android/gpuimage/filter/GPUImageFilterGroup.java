...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public void updateTextureSTMatrix(float[] stMatrix) {
        super.updateTextureSTMatrix(stMatrix);

        int size = mFilters.size();
        for (int i = 0; i < size; i++) {
            mFilters.get(i).updateTextureSTMatrix(stMatrix);
        }
    }
    ...
    @Override
    final public void onDraw(final int textureId, final FloatBuffer cubeBuffer,
