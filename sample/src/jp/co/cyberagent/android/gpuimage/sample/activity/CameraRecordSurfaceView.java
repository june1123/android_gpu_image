...
/**
 * Created by June on 2016. 1. 14..
 */
public class CameraRecordSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Choreographer.FrameCallback {
    private static final String TAG = "ActivityCameraRecoding";

    private CameraLoader mCamera;
    private GPUImageFilter mFilter;
    private FPSUpdateListener mFpsUpdateListener;

    public CameraRecordSurfaceView(Context context) {
        this(context, null);
    }

    public CameraRecordSurfaceView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CameraRecordSurfaceView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setFpsUpdateListener(FPSUpdateListener fpsUpdateListener) {
        ...
        if (mRenderThread != null) {
            mRenderThread.setFPSUpdateListener(fpsUpdateListener);
        }
    }

    public void openCamera(int cameraFacing) {
        mCamera.switchCamera(cameraFacing);
    }
    ...
    public boolean setRecordingEnabled(boolean enabled) {
        if (mRecordingEnabled != enabled) {
    ...
    private class CameraLoader {
        ...
        public void switchCamera(int facing) {
            this.mFacing = facing;
            int cameraId = mCameraHelper.getCameraId(facing);
        ...
        private void setUpCamera(int cameraId) {
            ...
            if( mCameraInstance != null ) {
                ...
                int orientation = mCameraHelper.getCameraDisplayOrientation(getContext(), mCurrentCameraId);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        mRenderThread = new RenderThread(sv.getHolder(), outputFile,
                getDisplayRefreshNsec(getContext()), mFpsUpdateListener);
    ...
    public interface FPSUpdateListener {
        void onFPSUpdated(int tfps, int dropped);
    }
    ...
    private static class RenderThread extends Thread {
        ...
        public RenderThread(SurfaceHolder holder, File outputFile,
                            long refreshPeriodNs, FPSUpdateListener fpsUpdateListener) {
            ...
            setFPSUpdateListener(fpsUpdateListener);
        }
            ...
            if (mFpsCountStartNanos == 0) {
                ...
                if (mFpsCountFrame == NUM_FRAMES) {
                    ...
                    if( mFpsUpdateListener != null ) {
                        mFpsUpdateListener.onFPSUpdated((int) (NUM_FRAMES * ONE_TRILLION / elapsed),
                                mDroppedFrames);
                    }
