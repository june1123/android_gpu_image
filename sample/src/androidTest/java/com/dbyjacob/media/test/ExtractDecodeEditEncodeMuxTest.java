...
public class ExtractDecodeEditEncodeMuxTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        GPUImageRenderer renderer = new GPUImageRenderer(gpuImageFilterGroup);
...
//    }
    ...
    public void testExtractDecodeEditEncodeMuxAudioVideo() throws Throwable {
        setSize(480, 480);
        inputSourcePath = "sdcard/debug/source_30sec_1080p.mp4";
        outputPath = "sdcard/debug/output_1080p_30sec_480_480.mp4";
    ...
    public void testExtractDecodeEditEncodeMuxAudioVideo2() throws Throwable {
        setSize(480, 480);
        inputSourcePath = "sdcard/debug/source_music_encoded.mp4";
        outputPath = "sdcard/debug/output_480x640_to_480x480.mp4";
    ...
    private static class TestWrapper implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.e("eee", "working time : " + (System.currentTimeMillis() - startTime) + " / " + mTest.inputSourcePath);
            } catch (Throwable th) {
                mThrowable = th;
            }
        }
    ...
    private void extractDecodeEditEncodeMux() throws Exception {
        ...
        try {
            if (mCopyVideo) {
                ...
                int w = outputVideoFormat.getInteger(MediaFormat.KEY_WIDTH);
                int h = outputVideoFormat.getInteger(MediaFormat.KEY_HEIGHT);

                outputSurface = new OutputSurface(mWidth, mHeight, w, h, mGPUImageRenderer);
...
//        return extractor;
        ...
        MediaExtractor extractor;
        extractor = new MediaExtractor();
        extractor.setDataSource(inputSourcePath);
        return extractor;
    }
